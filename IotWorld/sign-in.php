...
<body>
	...
	<div class="loginbox">
		...
		<h1>Login here</h1>
		<form method="post" action="something.php" onsubmit="return validateForm()" name="myForm">

			<p>Username</p>
				<input type="text" name="Username" placeholder="Enter Username" id="Username"/>

			<p>Password</p>
				<input type="password" name="" placeholder="Enter password" name="password" id="password" />
